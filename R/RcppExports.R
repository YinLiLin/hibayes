...
BayesK <- function(y, X, model, Pi, K, K_index, C = NULL, R = NULL, fold = NULL, niter = 50000L, nburn = 20000L, thin = 5L, epsl_y_J = NULL, epsl_Gi = NULL, epsl_index = NULL, dfvr = NULL, s2vr = NULL, vg = NULL, dfvg = NULL, s2vg = NULL, ve = NULL, dfve = NULL, s2ve = NULL, windindx = NULL, outfreq = 100L, threads = 0L, verbose = TRUE) {
    .Call(`_hibayes_BayesK`, y, X, model, Pi, K, K_index, C, R, fold, niter, nburn, thin, epsl_y_J, epsl_Gi, epsl_index, dfvr, s2vr, vg, dfvg, s2vg, ve, dfve, s2ve, windindx, outfreq, threads, verbose)
}

Bayes <- function(y, X, model, Pi, C = NULL, R = NULL, fold = NULL, niter = 50000L, nburn = 20000L, thin = 5L, epsl_y_J = NULL, epsl_Gi = NULL, epsl_index = NULL, dfvr = NULL, s2vr = NULL, vg = NULL, dfvg = NULL, s2vg = NULL, ve = NULL, dfve = NULL, s2ve = NULL, windindx = NULL, outfreq = 100L, threads = 0L, verbose = TRUE) {
    .Call(`_hibayes_Bayes`, y, X, model, Pi, C, R, fold, niter, nburn, thin, epsl_y_J, epsl_Gi, epsl_index, dfvr, s2vr, vg, dfvg, s2vg, ve, dfve, s2ve, windindx, outfreq, threads, verbose)
}
