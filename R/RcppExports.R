...
BayesK <- function(y, X, model, Pi, K, K_index, C = NULL, R = NULL, fold = NULL, niter = 50000L, nburn = 20000L, epsl_y_J = NULL, epsl_Gi = NULL, epsl_index = NULL, vg = NULL, dfvg = NULL, s2vg = NULL, ve = NULL, dfve = NULL, s2ve = NULL, windindx = NULL, outfreq = 100L, threads = 0L, verbose = TRUE) {
    .Call(`_hibayes_BayesK`, y, X, model, Pi, K, K_index, C, R, fold, niter, nburn, epsl_y_J, epsl_Gi, epsl_index, vg, dfvg, s2vg, ve, dfve, s2ve, windindx, outfreq, threads, verbose)
}

Bayes <- function(y, X, model, Pi, C = NULL, R = NULL, fold = NULL, niter = 50000L, nburn = 20000L, epsl_y_J = NULL, epsl_Gi = NULL, epsl_index = NULL, vg = NULL, dfvg = NULL, s2vg = NULL, ve = NULL, dfve = NULL, s2ve = NULL, windindx = NULL, outfreq = 100L, threads = 0L, verbose = TRUE) {
    .Call(`_hibayes_Bayes`, y, X, model, Pi, C, R, fold, niter, nburn, epsl_y_J, epsl_Gi, epsl_index, vg, dfvg, s2vg, ve, dfve, s2ve, windindx, outfreq, threads, verbose)
}

SBayesD <- function(sumstat, ldm, model, Pi, niter = 50000L, nburn = 20000L, fold = NULL, windindx = NULL, vg = NULL, dfvg = NULL, s2vg = NULL, ve = NULL, dfve = NULL, s2ve = NULL, outfreq = 100L, threads = 0L, verbose = TRUE) {
    .Call(`_hibayes_SBayesD`, sumstat, ldm, model, Pi, niter, nburn, fold, windindx, vg, dfvg, s2vg, ve, dfve, s2ve, outfreq, threads, verbose)
}

SBayesS <- function(sumstat, ldm, model, Pi, niter = 50000L, nburn = 20000L, fold = NULL, windindx = NULL, vg = NULL, dfvg = NULL, s2vg = NULL, ve = NULL, dfve = NULL, s2ve = NULL, outfreq = 100L, threads = 0L, verbose = TRUE) {
    .Call(`_hibayes_SBayesS`, sumstat, ldm, model, Pi, niter, nburn, fold, windindx, vg, dfvg, s2vg, ve, dfve, s2ve, outfreq, threads, verbose)
}
